export const ui = {
  ...
  admin: {
    ...
    suspend: 'Suspender',
    disable: 'Inhabilitar',
    removeAccess: 'Desactivar cuenta',
    removeTitle: 'Desactivar esta cuenta',
    removeWarning:
      'Esto quita el acceso de inmediato. La cuenta no se borra: queda desactivada y el cliente no podrá iniciar sesión. Los datos se conservan y puedes reactivarla después con «Dar acceso».',
    removeConfirmLabel: 'Escribe el correo del cliente para confirmar',
    removeConfirmHint: 'Debe coincidir exactamente con',
    removeConfirmAction: 'Desactivar cuenta',
    removeSuccess: 'Cuenta desactivada. El cliente ya no puede iniciar sesión.',
  ...
  aiSettings: {
    title: 'IA y créditos',
    subtitle: 'Consulta el saldo de OpenAI y elige el modelo que usará toda la plataforma.',
    available: 'Crédito disponible',
    used: 'Crédito usado',
    estimated: 'Gasto estimado del mes',
    analyses: 'Análisis este mes',
    activeModel: 'Modelo activo',
    modelsTitle: 'Modelos disponibles',
    modelsLead: 'El modelo que actives lo usarán todos los análisis: misiones, drones y reportes.',
    useModel: 'Usar este modelo',
    inUse: 'En uso',
    pending: 'Pendiente',
    training: 'En desarrollo',
    trainingCost: 'Sin costo de OpenAI',
    gptCredits: 'Créditos OpenAI',
    unavailable: 'No disponible en esta cuenta',
    vision: 'Visión',
    billing: 'Abrir billing de OpenAI',
    creditsUnavailable:
      'No se pudo leer el saldo de OpenAI. Puedes consultar el panel y cambiar el modelo igual.',
    keyMissing: 'Falta la clave de OpenAI en el servicio de IA.',
    unreachable: 'No se pudo conectar con OpenAI.',
    noQuota: 'Sin saldo para analizar',
    ready: 'Panel listo',
    switched: 'Modelo activo actualizado. Toda la plataforma usará esta IA.',
    refresh: 'Actualizar',
  },
  missionSimulator: {
